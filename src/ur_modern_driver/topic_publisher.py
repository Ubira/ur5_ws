...
def talker():
    ...
    while not rospy.is_shutdown():
        ...
        #waypoints.data = [-1.44, 1.4, 0.6, -1.57, 0, -1.57, -1.0, 0.7, 0, -0.5, 0.7, -1.0, -0.3, 0.5, -0.5, 0, 0, 0, -0.3, 0.5, -0.5, 0, 0, 0, -0.3, 0.5, -0.5, 0, 0, 0, -0.3, 0.5, -0.5, 0, 0, 0, -0.3, 0.5, -0.5, 0, 0, 0]
        #waypoints.data = [-1.0, 0.7, 0, -1.57, 0, -1.57, -1.44, 1.4, 0.6]
        waypoints.data = [-1.57, 0, -1.57]
